...
// Date 객체는 UTC (협정세계시)를 기준으로 1970sus 1월 1일 자정부터 경과 시간을 계산 (밀리초로 계산)
// 불변성 없음; 현재 실무에서 거의 사용되진 않음
...
//        DateFunc();
    ...
    static void DateFunc() {
        ...
        f6 = new SimpleDateFormat("오늘은 yyyy년의 w 주차 입니다.");
    ...
    // java.util 에 포함.
    // Calendar 클레스는 추상 클래스로, 특정 국가나 문화의 달력 시스템에 맞게 하위 클래스가 구현
    static void calendarFunction() {
