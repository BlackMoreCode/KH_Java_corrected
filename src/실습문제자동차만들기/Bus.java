...
public class Bus extends Vehicle{
    ...
    void drive() {
        ...
        if (sel_passenger_num < 20) sel_passenger_num = 20;

        // 20명보다 많은데 20의 배수가 아니라면
        if (sel_passenger_num > 20 && sel_passenger_num % 20 != 0) {
            // 다음 20의 배수로 맞춰줘라!
            sel_passenger_num += (20 - (sel_passenger_num % 20));
        }
